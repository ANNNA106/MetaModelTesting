...
from datamodels.Cifar.ResNet import resnet_32
...
def generate_CIFAR_dataset_and_model(ensemble_size=1,
   ...
   # input image dimensions
    ...
    for i in range(ensemble_size):
        ...
        if not data_augmentation:
            member_filename = os.path.join(member_dir, 'cifarmodel.h5')
        else:
            member_filename = os.path.join(member_dir, 'cifarmodel_aug.h5')
